...
cities = {
    'москва': ['997614/51e5168a2878792f05fd', '997614/fbf7e47e552787031268'],
    'нью-йорк': ['997614/6a50c4fc3eaf1fbc3a0c', '997614/ddbf8279bb3bde582925'],
    'париж': ['1540737/5cc4283d5381e9197e18', '997614/26b584cdfae3425332a1'],
    'польша': ['13200873/2003381e5dec65973424','213044/9f5207d3a04363acc2ab']
}
    ...
    if sessionStorage[user_id]['first_name'] is None:
        ...
        if not sessionStorage[user_id]['game_started']:
            if 'помощь' in req['request']['nlu']['tokens']:
                res['response']['text'] = 'Я буду показывать фотки городов а вы должны их угадать'
